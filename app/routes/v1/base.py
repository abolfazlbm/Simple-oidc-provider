...
from app.resources.auth.login import UserLoginResource, TokenRefreshResource, SignoutResource, Singout2Resource
from app.resources.auth.user import UserListResource, UserResource, UserChangePassResource
